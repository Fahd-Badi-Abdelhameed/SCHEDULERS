...
void TIMER0_voidOVF_InterruptEnable(void){
...
void TIMER0_voidOVF_InterruptDisable(void){
...
void TIMER0_voidOVF_SetCallBack(void(*Local_Fptr)(void)){

	TIMER0_OVF_CallBack = Local_Fptr;
